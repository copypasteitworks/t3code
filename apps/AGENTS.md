# Testing Rules — Source Code

Rules in this file apply when working in this source directory.
...
- An assertion based solely on reading source and assuming what it "should" do is prohibited.
