...
describe("orchestration projector", () => {
  ...
  it("reconciles a running latest turn when the session becomes interrupted or stopped", async () => {
    const createdAt = "2026-02-23T08:00:00.000Z";
    const runningAt = "2026-02-23T08:00:05.000Z";
    const stoppedAt = "2026-02-23T08:00:07.000Z";
    const model = createEmptyReadModel(createdAt);
    ...
    const thread = afterInterrupted.threads[0];
